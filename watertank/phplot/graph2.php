...
$dt_graph=$_GET["date"];
$sql="SELECT `date_time`, `sensor4` FROM `logs1` where `date_time` like '%$dt_graph%' ORDER BY `date_time`";
// $flowrate= $row["sensor4"];
//echo"$sql<br>";
...
function draw_graph($arr2d){
    $plot = new PHPlot(750, 490); //size of graph 
