...
//========================================jpss========================================================
/*
function query_results_COPY1($sql){
	//require_once '../util/vars_mysql.php';
	//global $db_server, $db_username, $db_pwd,$db_name;
	$db_server='localhost';$db_username='root';$db_pwd='54321';$db_name='cms';	
...
function query_result_table_COPY1($results){

$k=0;
$w1=50;
echo"<table border='1'>";
while($row = fetch_arr_COPY1($results))
{	$k=$k+1;
	echo"<tr>";
	$i=0;
	while(@$row[$i]!=NULL){
...
function row_count_COPY1($results){
	$row_count=mysqli_num_rows($results);
	return $row_count;
}

function fetch_arr_COPY1($result){
	$row = @mysqli_fetch_array($result);
	return $row;
}

function print_array_COPY1($array){
