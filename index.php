      ...
      <div class="home_container container grid">
            <div class="about_content grid ">
              ...
              <!-- <div class="about_content grid"> -->
                ...
                <div class="home_data">
                  <p class="home_p">A web application for IoT-based smart water tank system project. This website was developed for one of my degree course subject. Therefore data from the sensor cannot be obtained currently since the hardware has stopped working. This web application is created using HTML, CSS & Javascript as frontend and PHP & MySQL as backend.<br><br>
                  “Water Tank Monitoring System” is introduced to overcome the drawbacks in the existing system. In this system, Arduino Uno microcontroller will send data to database, then the data will be shown through live server on this web application. <br><br>
                  Water tank users can see the instant of their water tank status and the measurement.
                  The user can see data changes within real time based on the sensor that been set at the water tank prototype system. The most important feature is data graphs which are automatically generated by this web application. 
                  For further information, click this <a href="https://drive.google.com/file/d/19esrpKgDccK4z_4oQX7IxlaaDTWvjPK4/view?usp=sharing" class="report-link" target="_blank" > project report</a>.
